...
function drawTitle(mainTitle, yTitle, ngroup, gvarNumber, gvarName, dvarNumber, dvarName) { 
        ...
        gstr = mainTitle;
        if(mainTitle == null) {
          if (LineGraph)      gstr += " 꺽은선그래프";
          else if(PieChart)   gstr += " 원그래프";
          else if(DonutGraph) gstr += " 도넛그래프";
          else if(BandGraph)  gstr += " 띠그래프";
          else                gstr += " 막대그래프";
        }
...
//        table.createCaption().innerHTML = "도수분포표";
        ...
        if (ngroup < 2) { // ngroup=1일때는 도수분포표
          ...
          cell[0].innerHTML = "번호";
          cell[1].innerHTML = "변량값";
          cell[2].innerHTML = "변량값명";
          cell[3].innerHTML = "도수";
          cell[4].innerHTML = "백분률(%)";   
          for (k=0; k<ncol; k++) {
...
//          for (k=1; k<4; k++)  cell[k].style.width ="70px";
          ...
          cell[0].innerHTML = "분석변량";
          cell[0].style.backgroundColor = "#eee";
          cell[1].innerHTML = dvarName;
          cell[2].innerHTML = "그룹변량:";
          cell[2].style.backgroundColor = "#eee";
